-- ============================================================
-- Mythsensus â Supabase Security Hardening Config
-- FIX: SEC-H06, SEC-L03, SEC-M05 â Infrastructure security
...
-- ============================================================
-- FIX: SEC-H05 â All SECURITY DEFINER functions must have:
...
-- ============================================================
-- 4. [DASHBOARD] Auth Settings â Email Verification
-- ============================================================
-- FIX: SEC-M05 â Require email verification
--
...
-- ============================================================
-- FIX: SEC-H02 â Additional API-level rate limiting
--
...
-- ============================================================
-- FIX: SEC-C02 â PDF reports must be in private bucket
--
...
-- ============================================================
-- FIX: SEC-L03 â Restrict CORS origins
--
-- Go to: Supabase Dashboard > Settings > API
...
-- ============================================================
-- FIX: SEC-C03, SEC-L04 â Automated data retention
