-- ============================================================
-- Mythsensus â PDPA Consent Management Schema
-- FIX: SEC-C01 â PDPA Compliance
...
COMMENT ON TABLE public.consent_records IS
  'PDPA: Records each user consent decision per purpose and version. Immutable â new consent creates new row.';
