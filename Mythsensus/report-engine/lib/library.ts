...
export const LIBRARY_SYSTEMS: LibrarySystem[] = [
  ...
  { id: 7,  slug: 'human-design',           nameEn: 'Human Design',               nameTh: 'Human Design · ระบบประเภทพลังงาน', icon: '⚡', origin: 'Ibiza, 1987',  age: '35 yrs',     region: 'Modern / Global',    tagline: 'A transmission received in 8 days and nights' },
