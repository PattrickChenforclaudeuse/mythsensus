...
function calcNineStar(d: BirthData): NineStarData {
  ...
  const analysis2026 = isHonmei
    ...
    : tPick(
        ...
        `2026 (Year of Fire Star 9) with your Star ${star} — ${pDir(data.dir)} is your lucky direction; use it to support work and sleep energy.`);
...
const ADDON_COSMIC_BY_TIER: Record<string, any> = {
  'Celestial': {
    ...
    desc:'26 ศาสตร์เห็นตรงกัน — บุคลิกภาพของคุณสะท้อนหลักจักรวาลที่เหนือกาลเวลา',
    story:'ในอุปนิษัทเล่าว่า Brahman คือ "Tat Tvam Asi — เจ้าคือสิ่งนั้น" · ฤาษีอุทาลกะอธิบายลูกชาย Svetaketu ว่า "เกลือละลายในน้ำ มองไม่เห็นแต่ลิ้มได้ทุกหยด — ตัวคุณก็ละลายอยู่ในจักรวาลแบบนี้". 26 ศาสตร์เห็นตรงกันในระดับ Celestial แปลว่าคุณสะท้อน "หลักการที่อยู่เบื้องหลังทุกระบบ" — ไม่ใช่ระบบใดระบบหนึ่ง แต่สิ่งที่ระบบทั้งหลายพยายามอธิบาย',
    practice:'นั่งเงียบ 10 นาทีก่อนตัดสินใจใหญ่ · ถามตัวเองว่า "สิ่งนี้ alignment กับหลักการลึก หรือแค่ตอบสนองสภาพชั่วคราว?" · พลังของคุณคือ "ความนิ่งที่คนรอบข้างมาพึ่ง" — ใช้เมื่อจำเป็น ไม่ใช่ทุกครั้ง',
  },
  'Radiant': {
    name:'โพธิสัตว์ · Bodhisattva',
    desc:'พลังงานที่เอื้อเฟื้อ ปัญญาสูง พร้อมยกระดับผู้รอบข้าง',
    story:'โพธิสัตว์คือผู้บรรลุแล้วแต่เลือก "ไม่เข้านิพพาน" จนกว่าจะช่วยสรรพสัตว์พ้นทุกข์ทั้งหมด · พระอวโลกิเตศวร (กวนอิมในจีน) มี 1,000 มืออันละดวงตา — แต่ละมือถือเครื่องมือคนละชนิด เพราะวิธีช่วยคนมีพันแบบ. ระดับ Radiant แปลว่าพลังของคุณ "เกินกว่าใช้สำหรับตัวเอง" — มันล้นออกหล่อเลี้ยงคนรอบข้างโดยอัตโนมัติ และเป็นสาเหตุที่คนถูกดึงเข้ามาในวงโคจรคุณ',
    practice:'ทุกสัปดาห์ระบุ 1 คนในชีวิตที่คุณ "ยกขึ้น" ได้ (mentor · introduce · open a door) · ลงมือทำโดยไม่หวังผลตอบแทน · พลังโพธิสัตว์ทบทวีเมื่อใช้ — ไม่ใช่เมื่อเก็บไว้',
  },
  'Luminous': {
    name:'โพธิสัตว์ · Bodhisattva (focused)',
    desc:'พลังงานเอื้อเฟื้อแบบโฟกัส — เก่งเฉพาะด้านลึก ช่วยคนได้ตรงประเด็น',
    story:'ระดับ Luminous พลังโพธิสัตว์ของคุณ "โฟกัส" มากกว่า Radiant — เปรียบเหมือนเลเซอร์เทียบกับไฟส่อง · พระอวโลกิเตศวรในรูป Avalokita (รูปนิ่ง) สะท้อนสิ่งนี้ — ไม่ใช่ทุกอย่างกับทุกคน แต่ตรงทางกับคนที่ต้องการลึกๆ. คุณคือ "ผู้เชี่ยวชาญที่คนค้นหา" — ไม่ใช่ generalist ที่กระจายตัว',
    practice:'ระบุ "สิ่งที่คุณทำได้ดีกว่าคนอื่นจริงๆ" 1 อย่าง · มอบให้ใครก็ตามที่ขอผ่านคุณ · อย่าทำสิ่งที่ไม่ใช่ specialty — กระจายพลังจะ dilute จนหาย',
  },
  'Resonant': {
    name:'ไท้ยี่ · Tai Yi',
    desc:'สมดุลระหว่างยิน-หยาง พลังงานที่กลมกลืนและทรงพลัง',
    story:'ไท้ยี่ (Taiyi) คือเทพดวงดาวสูงสุดในศาสนาเต๋า · อยู่ที่ขั้วโลกเหนือบนฟ้า — เป็นจุดที่ดาวอื่นๆ หมุนรอบ แต่ตัวเองนิ่ง · ตำราเต๋าบอกว่าผู้ที่ "เป็น Taiyi" คือคนที่หาความสมดุลระหว่าง Yin (สงบ) กับ Yang (เคลื่อนไหว). เมื่อ 26 ศาสตร์เห็นตรงกันในระดับ Resonant ตัวคุณคือ "จุดศูนย์กลาง" ที่ผู้อื่นรู้สึกได้ — มีเสน่ห์เพราะ balance ไม่ใช่เพราะเด่นด้านใดด้านหนึ่ง',
    practice:'ฝึก "ไม่ตอบ" เมื่อมีความขัดแย้ง · รอ 24 ชม. ก่อนตัดสินใจ · ดูว่าหลังพักความ urgent ลดลง ความสำคัญจริงจะชัดขึ้น · พลัง Taiyi เพิ่มเมื่อไม่รีบ',
  },
  'Grounded': {
    name:'วายุ · Vayu',
    desc:'พลังงานแห่งการเปลี่ยนแปลงและการเคลื่อนไหว — ยืดหยุ่นและปรับตัวเก่ง',
    story:'Vayu ในพระเวทคือเทพแห่งลม — มองไม่เห็น แต่รู้สึกได้ทุกที่ · เป็นพ่อของหนุมาน (พลังกายในรามายณะ) และภีมะ (พลังกายในมหาภารตะ) — พลังของวายุคือ "การเคลื่อนที่ที่ปรับตัวได้" — ไม่ฝืน แต่ไม่หลุดเป้าหมาย. ระดับ Grounded แปลว่าคุณมีรากมั่นคงแต่ไม่แข็งเกินไปจนแตก — เหมือนต้นไผ่ในพายุ',
    practice:'เมื่อรู้สึก stuck ลองเปลี่ยนสภาพแวดล้อม (เดินทาง · ย้ายโต๊ะทำงาน · เปลี่ยนกิจวัตรเล็กๆ) · พลัง Vayu มาจากการเคลื่อนไหวที่ไม่เปลี่ยนจุดหมาย · "งานหนัก = ขุดรากให้ลึก ไม่ใช่ฝืนแล้วแตก"',
  },
  'Seeking': {
    name:'อาร์เจส · Arges',
    desc:'พลังงานที่กำลังค้นหาตัวเอง — ศักยภาพสูงรอการปลดปล่อย',
    story:'Arges เป็น 1 ใน 3 Cyclopes ในเทพปกรณัมกรีก — ผู้สร้างอาวุธให้ Zeus (สายฟ้า), Poseidon (สามง่าม), Hades (หมวกพราง) · พลังของ Arges คือ "ผู้สร้างที่อยู่เบื้องหลัง" — ไม่ใช่ผู้ใช้ แต่ผู้ทำ. ระดับ Seeking แปลว่าคุณกำลังในช่วง "สะสมเครื่องมือ" — ทุกสิ่งที่เรียนรู้ตอนนี้คือเครื่องมือเตรียมตัวสำหรับสร้างสิ่งใหญ่ทีหลัง',
    practice:'หา mentor 1 คนใน field ที่อยากเก่ง · ใช้เวลา 1 ชม./สัปดาห์ apprentice · ถามคำถามมากกว่าตอบ · พลัง Arges เพิ่มจากการ accumulate skill — ไม่ใช่ broadcast ก่อนพร้อม',
  },
  'Emerging': {
    name:'อาร์เจส · Arges (rising)',
    desc:'พลังงานที่กำลังก่อตัว — เมล็ดพันธุ์ของศักยภาพที่รอการเติบโต',
    story:'ในระดับ Emerging Arges เพิ่งเริ่มเรียนรู้เครื่องมือเบื้องต้น · ใน Theogony ของ Hesiod เล่าว่า Cyclopes ถูก Cronus กักไว้ในดินดำใต้ Tartarus จน Zeus ปล่อย — แล้วพวกเขาก็ตอบแทนด้วยสายฟ้า. บทเรียนคือ "พลังที่ถูกกดอยู่นานคือพลังที่จะเปลี่ยนโลกเมื่อปล่อย" · ตอนนี้คุณอยู่ในช่วง "ดินดำ" ของ Cyclopes — สะสมเงียบๆ ก่อนเปล่งแสง',
    practice:'ทุกวัน ลงมือทำสิ่งเล็กๆ 1 อย่างที่ไม่มีใครเห็น (เรียน · ฝึก · เขียน) · 6 เดือนต่อมา ความ accumulate จะกลายเป็น breakthrough · พลัง Emerging คือ compound interest — ไม่ใช่ flash spectacular',
  },
};
...
function _buildSynthesis(
  ...
  if (signals.length === 0) return lang === 'th' ? 'วันธรรมดา ไม่มีสัญญาณเด่น' : 'Quiet day, no strong signal.';
  const intro = lang === 'th'
